...
//         if (colonAt >= 0)
//           dataAfterColon = dataAfterColon.substring(colonAt + 1);
//         if (!dataAfterColon) {
//           dataAfterColon = data;
//         }
//         let slashAt = dataAfterColon.lastIndexOf('/');
//         if (slashAt >= 0)
//           dataAfterColon = dataAfterColon.substring(slashAt + 1);
//         if (!dataAfterColon) {
//           dataAfterColon = data;
//         }
...
//           this.props.returnState.view != 'send_to_address'
//         ) {
...
//
//         Promise.all([base64ToBitmap(e.target.result), import('qrcode-reader')])
...
//                       style={{
//                         backgroundColor: this.props.mainStyle.mainColor
//                       }}
//                     >
